...
public class Scenario {
	...
	public static void scenario2() {
		/*
		Sachant que minus à une force de 6, astérix une force de 8 et Obélix une force de
		25, modifier le scénario de la classe Scenario pour obtenir la sortie suivante 
