...
public class Gaulois {
	...
	public void boirePotion(int forcePotion) {
		/*
		 * prend en paramètre d’entrée la force de la potion et l’affecte à l’attribut
		 * effetPotion. Le gaulois dit : « Merci Druide, je sens que ma force est N fois
		 * décuplée. » si la force de la potion est de N.
		 */
